...
export default function Home() {
    return (
        ...
        <main>
            <section id="hero" className="flex flex-col items-center gap-4 px-8 py-24 lg:py-80 ">
                <h1>Scriptorium</h1>
                <h3>Dive right into the thick of it.</h3>
            </section>

            <section id="bio" className="flex flex-col md:flex-row rounded-2xl border-2 border-primeBlue gap-16">
                <div className="description flex-1 flex flex-col items-center md:items-start gap-6 md:gap-12">
                    <h2>Meet the new way of writing code.</h2>
                    <p>Scriptorium is an innovative online platform where you can write, execute, and share code in multiple programming languages. 
                        Inspired by the ancient concept of a scriptorium, a place where manuscripts were crafted and preserved, 
                        Scriptorium modernizes this idea for the digital age. It offers a secure environment for geeks, nerds, and coding enthusiasts 
                        to experiment, refine, and save their work as reusable templates. Whether you’re testing a quick snippet or building a 
                        reusable code example, Scriptorium is what you need to bring your ideas to life.
                    </p>
                    <button onClick={() => {
                        const isAuthenticated = localStorage.getItem("accessToken");
                        window.location.href = isAuthenticated ? "/ide" : "/user/login";
                    }} id="internal-link">Get Started</button>
                </div>
                <div className="image m-auto flex basis-2/5 justify-center items-center text-center w-40 text-primeRed">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 648 648" className="fill-primeRed">
                    <g><path d="M188.52,535.66c.65.08,6.93.8,11.08-3.74,4.03-4.41,4.34-11.88-.12-16.69-4.17-4.5-11.14-5.18-15.99-1.82-5.46,3.78-6.96,11.81-2.84,17.76-13.6,19.81-27.2,39.62-40.8,59.42,2.12,1.47,4.26,2.91,6.41,4.32,9.57-12.46,19.11-25.44,28.54-39,4.72-6.79,9.29-13.54,13.72-20.25Z"/>
            ...
            {/* TODO: Implement Featured Templates if time enables */}
            {/* <section id="featured" className="flex flex-col rounded-2xl border-2 border-primeBlue">
